...
# Edited version of the aliens example game in the PyGame package
### Added gravity for bombs and shots (which can fall back on the player)
### Aliens can collide and they explode
...
def main(winstyle=0):
    ...
    while player.alive():
        ...
        # See if shots hit the player.
        for shot in pg.sprite.spritecollide(player, shots, 1):
            if pg.mixer and boom_sound is not None:
                boom_sound.play()
            Explosion(shot, all)
            Explosion(player, all)
        ...
        for alien in pg.sprite.spritecollide(all_aliens, aliens, 1):
            if pg.mixer and boom_sound is not None:
                boom_sound.play()
            Explosion(alien, all)
