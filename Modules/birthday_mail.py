...
def send_email(recipient, subject, msg):
    ...
    gmail_psw = os.getenv('GooglePSW')
    gmail_email = os.getenv('GoogleEmail')
    GMAIL_ID = gmail_email # 'your_email_here'
    GMAIL_PWD = gmail_psw # 'your_password_here'
...
def send_bday_emails(bday_file):
    try:
        ...
        print(f"File {bday_file} not found!")
